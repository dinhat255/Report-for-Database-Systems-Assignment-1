...
\fancyhead[L]{
 \begin{tabular}{rl}
    ...
    \put(0,-8){\includegraphics[width=8.7mm, height=8.7mm]{picture/01_logobachkhoasang.png}}
   \end{picture}&
	\begin{tabular}{l}
...
\include{content/Bìa} 
\tableofcontents 
\include{content/Giới thiệu}
\include{content/Tìm hiểu ứng dụng hoặc hệ thống liên quan}
\include{content/Mô tả hệ thống đề xuất}
\include{content/Thiết kế EERD}
\include{content/Ánh xạ sang lược đồ CSDL}
\end{document}